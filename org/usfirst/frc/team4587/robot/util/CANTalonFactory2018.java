...
/*?*/        public double CLOSED_LOOP_RAMP_RATE = 0;
   ...
   //?     talon.setStatusFrameRateMs(CANTalon.StatusFrameRate.PulseWidth, config.PULSE_WIDTH_STATUS_FRAME_RATE_MS);
    ...
    public static String getFullTalonInfo(WPI_TalonSRX talon) {
        StringBuilder sb = new StringBuilder().append("isRevLimitSwitchClosed = ")
                .append(talon.getSensorCollection().isRevLimitSwitchClosed()).append("\n")//.append("getBusVoltage = ")
 ...
 //?               .append("\n").append("getNumberOfQuadIdxRises = ").append(talon.getNumberOfQuadIdxRises())
                .append("\n")
                ...
                .append("getError = ").append(talon.getClosedLoopError(10)).append("\n")
 ...
 //?               .append("isZeroSensorPosOnRevLimitEnabled = ").append(talon.isZeroSensorPosOnRevLimitEnabled()).append("\n")
                ...
                .append("getOutputVoltage = ").append(talon.getMotorOutputVoltage()).append("\n").append("getTemperature = ")
 ...
 //?               .append(talon.getSmartDashboardType()).append("\n")
                ...
                .append(talon.getSensorCollection().getPulseWidthPosition()).append("\n").append("getOutputCurrent = ")
